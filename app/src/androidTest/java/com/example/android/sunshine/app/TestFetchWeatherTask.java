...
public class TestFetchWeatherTask extends AndroidTestCase{
    ...
    public void testAddLocation() {
        ...
        FetchWeatherUtils fwt = new FetchWeatherUtils();
        long locationId = fwt.addLocation(getContext(),ADD_LOCATION_SETTING, ADD_LOCATION_CITY,
        ...
        for ( int i = 0; i < 2; i++ ) {
            ...
            long newLocationId = fwt.addLocation(getContext(),ADD_LOCATION_SETTING, ADD_LOCATION_CITY,
                    ADD_LOCATION_LAT, ADD_LOCATION_LON);
